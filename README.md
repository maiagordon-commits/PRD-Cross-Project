...
For Room Migration: enrich Segments from Guesty (`python3 enrich_segments_from_guesty.py`), then `python3 create_room_migration_dashboard.py` — see `ROOM_MIGRATION_README.md` (needs Guesty HQ export or `GUESTY_HQ_TOKEN`).
